...
import unittest
import tomograph
from main import compute_tomograph, gaussian_elimination, compute_cholesky
...
class Tests(unittest.TestCase):
    ...
    def test_cholesky_decomposition(self):
        ...
        self.assertTrue(np.allclose(L, L_np), "Cholesky decomposition does not match numpy result")
